...
for dataset_name in dataset_names:
    ...
    evaluate_quasistable_cv(
        disjoint_graph, graph_id_label_map, q_grid, n_max, c_grid, folds=10, dataset_name=dataset_name, repeats=5, start_repeat=2
    )

    evaluate_wl_cv(
        disjoint_graph, graph_id_label_map, h_grid, c_grid, folds=10, dataset_name=dataset_name, repeats=5, start_repeat=2
    )

    evaluate_gwl_cv(disjoint_graph, graph_id_label_map, h_grid, k_grid, c_grid, dataset_name=dataset_name, folds=10, repeats=5, start_repeat=2)